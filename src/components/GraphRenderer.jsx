      ...
      <Box display="flex" sx={{ backgroundColor: "#222", padding: 0.6 }}>
        <Tooltip title="Play Simulation">
          <IconButton
            ...
            onClick={() => cosmograph.current?.start()}
            sx={{
              color: "white", // 图标颜色
            }}>
            <PlayArrowIcon />
        ...
        <Tooltip title="Pause Simulation">
          <IconButton
            ...
            onClick={() => cosmograph.current?.pause()}
            sx={{
              color: "white", // 图标颜色
            }}>
            <PauseIcon />
        ...
        <Tooltip title="Restart Simulation">
          <IconButton
            ...
            onClick={() => cosmograph.current?.create()}
            sx={{
              color: "white", // 图标颜色
            }}>
            <ReplayIcon />
        ...
        {dynamicLabels ? (
          <Tooltip title="Hide Dynamic Labels">
            <IconButton
              ...
              onClick={() => setDynamicLabels(false)}
              sx={{
                color: "white", // 图标颜色
              }}>
              <LabelOutlinedIcon />
